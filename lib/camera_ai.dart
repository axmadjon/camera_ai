...
final MethodChannel _channel = const MethodChannel('plugins.datalab.uz/camera');
...
typedef onFaceAnaliyze = Function(String result);
...
class CameraController extends ValueNotifier<CameraValue> {
  ...
  Future<void> initialize() async {
    ...
    _eventSubscription =
        EventChannel('datalab.uz/cameraPlugin/cameraEvents$_textureId')
  ...
  Future<void> resetFaceId(List<String> ids) async {
    final args = <String, dynamic>{"ids": ids.join(",")};
    await _channel.invokeMethod<void>("resetFaceId", args);
  }
  ...
  Future<void> startImageStream(
    ...
    try {
      await _channel.invokeMethod<void>('startImageStream', <String, dynamic>{
        "face_analyze": faceAnalyze,
        "only_base64": onlyBase64,
      });
    ...
    EventChannel('plugins.datalab.uz/camera/imageStream');
